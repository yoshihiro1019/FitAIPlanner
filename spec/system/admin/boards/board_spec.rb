...
RSpec.describe '管理画面/掲示板', type: :system do
  ...
  describe '掲示板詳細' do
    ...
    it '掲示板の詳細情報が表示されること' do
      ...
      Capybara.assert_current_path("/admin/boards/#{board1.id}", ignore_query: true)
  ...
  describe '掲示板編集' do
    ...
    it '掲示板を編集できること' do
      ...
      click_on '編集'
      Capybara.assert_current_path("/admin/boards/#{board1.id}/edit", ignore_query: true)
  ...
  describe '掲示板削除' do
    it '掲示板を削除できること' do
      ...
      Capybara.assert_current_path("/admin/boards", ignore_query: true)
